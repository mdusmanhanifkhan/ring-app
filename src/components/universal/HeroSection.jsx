...
const HeroSection = () => {
  ...
  return (
    <div ref={sectionRef} className="relative h-[80vh] md:h-screen w-full">
      ...
      {/* Hero Content */}
      <div
        className="relative z-10 flex flex-col gap-2 items-center justify-center pt-25 md:pt-30 lg:pt-46 text-white
          "
      >
        <span className="text-[9px] font-medium uppercase tracking-[0.35em] text-muted sm:text-[11px] sm:tracking-[0.4em]">
          Timeless • Refined • Iconic
        </span>

        <h1 className="max-w-5xl text-center font-serif text-[32px] font-semibold italic leading-[1.05] tracking-[-0.04em] text-primary sm:text-[56px] md:text-[68px] lg:text-[76px]">
          Crafted to Be
      ...
      <div className="relative h-full w-full">
        <div
          ref={ringRef}
          className="absolute -top-48 md:-top-80 z-40 h-full w-full scale-[0.9] md:scale-100"
        >
          <RingModel />
        </div>
